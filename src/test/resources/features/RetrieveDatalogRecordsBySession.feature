Feature: Retrieve datalog records by session id
  ...
  Scenario: Retrieve datalog records for a session that does not exist
    Given the following datalog records exist:
      | sessionId                            | timestamp                | longitude          | latitude            | altitude | intakeAirTemperature | boostPressure | coolantTemperature | engineRpm | throttlePosition |
      | c61cc339-f93d-45a4-aa2b-923f0482b97f | 2022-09-18T14:15:47.968Z | -86.14170333333335 | 42.406800000000004  | 188.4    | 123                  | 15.6          | 150                | 5000      | 75.6             |
      | c61cc339-f93d-45a4-aa2b-923f0482b97f | 2022-09-18T14:15:48.962Z | 86.14162999999999  | -42.406816666666664 | 188.0    | 130                  | 15            | 165                | 5500      | 75.0             |
