Feature: Retrieve datalog records by session id
  ...
  Scenario: Retrieve datalog records for a session with a single record
    Given the following datalog records exist:
      ...
      | c61cc339-f93d-45a4-aa2b-923f0482b97f | 2022-09-18T18:15:47.968Z | 123                  | 15.6          | 150                | 5000      | 85    | 75.6             |
  ...
  Scenario: Retrieve datalog records for a session with multiple records
    Given the following datalog records exist:
      | sessionId                            | timestamp                | intakeAirTemperature | boostPressure | coolantTemperature | engineRpm | speed | throttlePosition |
      | c61cc339-f93d-45a4-aa2b-923f0482b97f | 2022-09-18T14:15:47.968Z | 123                  | 15.6          | 150                | 5000      | 85    | 75.6             |
      | c61cc339-f93d-45a4-aa2b-923f0482b97f | 2022-09-18T14:15:46.962Z | 130                  | 15.0          | 165                | 5500      | 80    | 75.0             |
    When the datalog records for session with id 'c61cc339-f93d-45a4-aa2b-923f0482b97f' are retrieved
    Then the request response status is 'OK'
    And the following data log records are returned:
      | sessionId                            | timestamp                | intakeAirTemperature | boostPressure | coolantTemperature | engineRpm | speed | throttlePosition |
  ...
  Scenario: Retrieve datalog records with null data
    Given the following datalog records exist:
      | sessionId                            | timestamp                | intakeAirTemperature | boostPressure | coolantTemperature | engineRpm | speed | throttlePosition |
      | c61cc339-f93d-45a4-aa2b-923f0482b97f | 2022-09-18T14:15:47.968Z | 123                  |               | 150                |           | 85    |                  |
      | c61cc339-f93d-45a4-aa2b-923f0482b97f | 2022-09-18T14:15:48.962Z |                      | 15.6          | 165                | 5000      |       | 75.6             |
      | c61cc339-f93d-45a4-aa2b-923f0482b97f | 2022-09-18T14:15:49.965Z | 130                  | 15.0          |                    | 5500      | 80    | 75.0             |
    When the datalog records for session with id 'c61cc339-f93d-45a4-aa2b-923f0482b97f' are retrieved
    Then the request response status is 'OK'
    And the following data log records are returned:
      | sessionId                            | timestamp                | intakeAirTemperature | boostPressure | coolantTemperature | engineRpm | speed | throttlePosition |
  ...
  Scenario: Retrieve datalog records for a session that does not exist
    Given the following datalog records exist:
      | sessionId                            | timestamp                | intakeAirTemperature | boostPressure | coolantTemperature | engineRpm | throttlePosition |
      | c61cc339-f93d-45a4-aa2b-923f0482b97f | 2022-09-18T14:15:47.968Z | 123                  | 15.6          | 150                | 5000      | 75.6             |
      | c61cc339-f93d-45a4-aa2b-923f0482b97f | 2022-09-18T14:15:48.962Z | 130                  | 15            | 165                | 5500      | 75.0             |
